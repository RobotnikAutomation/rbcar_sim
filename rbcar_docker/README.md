...
The docker uses [this repository](./..) as the source code for the workspace.
...
In case the container is stopped, run the following command to restart the container.
```bash
./restart.sh
```
